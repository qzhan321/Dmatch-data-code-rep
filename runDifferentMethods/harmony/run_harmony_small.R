...
src_dir = "/home/qizhan/scratch-midway2/others/dmatch_review/things_done_by_me/july17th-july23rd2020/broad_PBMC_10x_simulate_batch_effects/harmony/"
...
for (i in 1:10) {
  for (j in 1:3) {
    ...
    dmatch_out_filename = "_harmony_out"
    metadata_out_filename = "_harmony_metadata_out"
    ...
    saveout_dir = paste0("/project2/mengjiechen/qizhan/qizhan/dmatch/dmatch_response_to_review/others/broad_PBMC_10x_batch_effects_simulation_and_correction/corrected_data/pbmc1_10x_v2_A/harmony/", batch_effects, "/results/")
    dmatch_out_filename = "_samples"
    dmatch_out_pcs_filename = "_samples_pcs"
    plotout_dir <- paste0("/project2/mengjiechen/qizhan/qizhan/dmatch/dmatch_response_to_review/others/broad_PBMC_10x_batch_effects_simulation_and_correction/corrected_data/pbmc1_10x_v2_A/harmony/", batch_effects, "/plots/")
    ...
    b_seurat = call_harmony_2(b_seurat, batch_label, celltype_label, npcs, plotout_dir = plotout_dir, saveout_dir = saveout_dir, outfilename_prefix = outfilename_prefix, visualize = visualize, save_obj = save_obj)
